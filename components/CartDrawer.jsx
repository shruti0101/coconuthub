      ...
      <div className="relative w-[420px] max-w-full bg-white h-full shadow-2xl flex flex-col animate-slideIn">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {cart.length === 0 && (
            ...
            <div className="text-center gap-3 flex flex-col py-20 text-gray-500">
             <p>
                ...
                <Link href="/products">
                  ...
                  <button className="capitalize cursor-pointer bg-[#047775] py-3 px-3 text-white">browse products</button>
                </Link>
